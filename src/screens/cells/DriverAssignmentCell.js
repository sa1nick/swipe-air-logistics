...
const DriverAssignmentCell = props => {
  ...
  const styles = StyleSheet.create({
    ...
    separator: {
      width: '50%',
      height: 0.5,
      backgroundColor: isDark ? SAL.darkModeColors.seperator242424 : '#B1B1B1',
      marginTop: 10,
    },
    statusText: {
      color: '#0DBC93',
    ...
    locationTitle: {
      color: isDark ? SAL.darkModeColors.black1C1C1C : '#919191',
      fontSize: 8,
      fontFamily: 'Rubik-Regular',
    ...
    orangeButton: {
      ...
      height: 45,
      borderColor: isDark ? orange : '#FF6D09',
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        colors={[
          isDark ? 'rgba(255,183,133, 0.7)' : 'rgba(255,183,133, 0.2)',
